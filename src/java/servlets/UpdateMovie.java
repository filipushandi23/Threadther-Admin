...
import services.WSAdmin_Service;
...
public class UpdateMovie extends HttpServlet {
    ...
    @WebServiceRef(wsdlLocation = "WEB-INF/wsdl/localhost_8080/Threadther/WSAdmin.wsdl")
    private WSAdmin_Service service;
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        if (port.editMovie(movie_id, title, synposis, rating, duration, poster, status)) {
